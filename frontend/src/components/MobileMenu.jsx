...
const MobileMenu = ({ isOpen, onClose, type = 'user', groupId }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] lg:hidden">
            ...
            {/* Menu Panel */}
            <div className="absolute left-0 top-0 bottom-0 w-[min(88vw,20rem)] bg-white dark:bg-gray-900 shadow-2xl overflow-y-auto">
                {/* Header */}
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3 py-2.5 sm:px-4 sm:py-3 rounded-2xl transition-all ${isActive
                ...
                {/* Logout Button */}
                <div className="p-3 sm:p-4 border-t border-gray-200 dark:border-gray-700 mt-4">
                    <button
                        onClick={() => {
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 sm:px-4 sm:py-3 rounded-2xl text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all font-medium"
                    >
