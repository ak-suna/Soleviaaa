import express from "express"; //Web framework for API endpoints
import dotenv from "dotenv"; // Loads environment variables from .env file into process.env
import cors from "cors"; //Cross-Origin Resource Sharing
import { createServer } from "http"; // Creates a raw HTTP server that Express wraps around
import connectDB from "./config/db.js"; // Connects your backend to MongoDB
...
import "./jobs/accountLifecycleJobs.js"; 
